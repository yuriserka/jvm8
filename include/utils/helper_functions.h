...
// template <typename T>
// inline void getReference(const ClassFile *cf, const Utils::Types::u2
// &cp_index,
//                          std::string *ref_class_name,
//                          std::string *ref_method_name,
//                          std::string *ref_method_return = nullptr) {
//   namespace cp = ConstantPool;
//   T *ref = cf->constant_pool[cp_index - 1].getClass<T>();
//   cp::cp_info class_info_index = cf->constant_pool[ref->class_index - 1];
//   cp::cp_info nametype_info_index =
//       cf->constant_pool[ref->name_and_type_index - 1];

//   auto *ref_class_info =
//   class_info_index.getClass<cp::CONSTANT_Class_info>(); *ref_class_name =
//   cf->constant_pool[ref_class_info->name_index - 1]
//                         .getClass<cp::CONSTANT_Utf8_info>()
//                         ->getValue();

//   cp::CONSTANT_NameAndType_info *ref_nametype_info =
//       nametype_info_index.getClass<cp::CONSTANT_NameAndType_info>();
