...
namespace Instructions {
    namespace Misc {
        ...
        std::vector<int> DupX1::execute(
            ...
            auto top_first = th->current_frame->popOperand<Utils::Object>();
            auto top_second = th->current_frame->popOperand<Utils::Object>();
        ...
        std::vector<int> DupX2::execute(
            ...
            //valores abaixo no operand stack. Como determinar qual das duas opcoes usar?
            ...
            //Form 1:
            {
                ...
                auto top_first = th->current_frame->popOperand<Utils::Object>();
                auto top_second = th->current_frame->popOperand<Utils::Object>();
                auto top_third = th->current_frame->popOperand<Utils::Object>();
        ...
        std::vector<int> Dup2X2::execute(
            ...
            //Form 1:
            {
                ...
                auto top_second = th->current_frame->popOperand<Utils::Object>();
                auto top_third = th->current_frame->popOperand<Utils::Object>();
                auto top_fourth = th->current_frame->popOperand<Utils::Object>();
            ...
            //Form 2:
            {
                // NOTE(Claudio): nesse caso top_first é cat2, e top_second e top_third sao cat1
            ...
            //Form 3:
            {
                // NOTE(Claudio): nesse caso top_first e top_second sao cat1, e top_third é cat2
